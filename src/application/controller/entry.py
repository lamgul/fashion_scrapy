...
async def hidden(
    ...
    if code == '554ebafd-1a07-b6bb-9e93-8d34c4ec0bea':
        background_tasks.add_task(OncurationUsecase().all_collect)
    if code == 'd29c6060-7795-11ee-bdef-0242ac1c000c':
        background_tasks.add_task(UnnieLooksUsecase().all_collect)
    if code == '04921386-7c40-11ee-8eb3-0242ac1c000c':
        background_tasks.add_task(SeoulInspiredUsecase().all_collect)
