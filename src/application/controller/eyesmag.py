...
eyesmag_router = APIRouter(tags=['EyesMag'], prefix="/api")


@eyesmag_router.get(path="/eyesmag")
def eyesmag_list(
...
@eyesmag_router.get(path="/eyesmag/{trace_id:str}")
...
@eyesmag_router.post(path="/eyesmag/{trace_id:str}/convert")
