...
krazemedia_router = APIRouter(tags=['KrazeMedia'], prefix="/api")


@krazemedia_router.get(path="/krazemedia")
def krazemedia_list(
...
@krazemedia_router.get(path="/krazemedia/{trace_id:str}")
...
@krazemedia_router.post(path="/krazemedia/{trace_id:str}/convert")
