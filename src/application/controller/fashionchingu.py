...
fashionchingu_router = APIRouter(tags=['FashionChingu'], prefix="/api")


@fashionchingu_router.get(path="/fashionchingu")
...
@fashionchingu_router.get(path="/fashionchingu/{trace_id:str}")
...
@fashionchingu_router.post(path="/fashionchingu/{trace_id:str}/convert")
