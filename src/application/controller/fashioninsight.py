...
fashioninsight_router = APIRouter(tags=['FashionInsight'], prefix="/api")


@fashioninsight_router.get(path="/fashioninsight")
...
@fashioninsight_router.get(path="/fashioninsight/{trace_id:str}")
...
@fashioninsight_router.post(path="/fashioninsight/{trace_id:str}/convert")
