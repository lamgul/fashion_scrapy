...
yesstyle_router = APIRouter(tags=['Yesstyle'], prefix="/api")


@yesstyle_router.get(path="/yesstyle")
def yesstyle_list(
...
@yesstyle_router.get(path="/yesstyle/{trace_id:str}")
...
@yesstyle_router.post(path="/yesstyle/{trace_id:str}/convert")
