...
krazefashion_router = APIRouter(tags=['KrazeFashion'], prefix="/api")


@krazefashion_router.get(path="/krazefashion")
...
@krazefashion_router.get(path="/krazefashion/{trace_id:str}")
...
@krazefashion_router.post(path="/krazefashion/{trace_id:str}/convert")
