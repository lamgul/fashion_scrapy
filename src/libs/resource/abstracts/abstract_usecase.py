...
class AbstractUsecase(metaclass=ABCMeta):
    ...
    oncuration_repository: OncurationRepository = Provide[RepositoryContainer.oncuration_repository]
    seoulinspired_repository: SeoulInspiredRepository = Provide[RepositoryContainer.seoulinspired_repository]
